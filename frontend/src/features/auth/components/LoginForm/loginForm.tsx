  ...
  return (
    <Card.Root variant={"elevated"} width={"500px"}>
      ...
      <Card.Body display={"flex"} flexDirection={"column"} gap={8} pt={6}>
        <Field label="メールアドレス">
          <Input type={"text"} placeholder="example@example.com" backgroundColor={"green.100"} />
        </Field>
        <Field label="パスワード">
          <Input type="password" placeholder="example@example.com" backgroundColor={"green.100"} />
        </Field>
